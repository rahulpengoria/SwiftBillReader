...
//        self.textFieldText = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont(name: "EffraMedium-Regular", size: 16.0) as Any])
    ...
    func setText() {
        ...
        if self.textViewText == nil || self.textViewText?.string.isEmpty ?? true {
            self.textView.attributedText = NSAttributedString(string: placeholderText?.string ?? "", attributes: [NSAttributedString.Key.foregroundColor: self.textViewTextColor as Any, NSAttributedString.Key.font:
                self.textViewFont as Any])
            self.placeholderLabel.attributedText = nil
            
        } else {
            self.textView.attributedText = NSAttributedString(string: textViewText?.string ?? "", attributes: [NSAttributedString.Key.foregroundColor: self.textViewTextColor as Any, NSAttributedString.Key.font:
                self.textViewFont as Any])
